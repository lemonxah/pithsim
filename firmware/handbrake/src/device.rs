//! Device identity. The serial is derived from the factory eFuse MAC —
//! globally unique per chip — so it's deterministic every boot without
//! needing NVS persistence.
